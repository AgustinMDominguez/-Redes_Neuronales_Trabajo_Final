# Agustin Marcelo Dominguez - Dic 2020
...
def runConvolutionalAutoencoder(
    number_of_epochs,
    plot_graph=False,
    save_network=False,
    ...
    trained_dict = ac.train_cnn_for_assigment(number_of_epochs, mnist_data=mnist_data, mnist_test=mnist_test)
...
runConvolutionalAutoencoder(3, plot_graph=True, save_network=True, save_training_log=True, compare=False)